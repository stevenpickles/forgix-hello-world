...
/* BSP-owned early-boot markers. Application diagnostics owns 1..10; keeping
...
#define BSP_WATCHDOG_MARKER_PSRAM_POST ( (uint32_t) 0x100u )
#define BSP_WATCHDOG_MARKER_STARTUP ( (uint32_t) 0x101u )
