...
void test_console_starts_with_a_prompt_and_reports_idle_status_after_the_timeout( void )
{
    ...
    TEST_ASSERT_EQUAL_STRING(
        "forgix> \r\nid=B7 status=01 button=03 count=7 fpga_status=1\n"
        "forgix> \r\nid=B7 status=01 button=03 count=8 fpga_status=1\nforgix> ",
...
void test_completed_command_resumes_periodic_status_after_the_idle_timeout( void )
{
    ...
    TEST_ASSERT_EQUAL_STRING(
        "\r\nid=B7 status=01 button=03 count=9 fpga_status=1\n"
        "forgix> \r\nid=B7 status=01 button=03 count=10 fpga_status=1\nforgix> ",
        MOCK_BSP_ConsoleOutput() );
}
...
void test_watch_uses_the_requested_period_and_stops_before_echoing_a_key( void )
{
    ...
    TEST_ASSERT_EQUAL_STRING( "\r\nid=B7 status=01 button=03 count=11 fpga_status=1\nforgix> h",
                              MOCK_BSP_ConsoleOutput() );
}
...
void test_watch_survives_a_completed_command_line( void )
{
    ...
    TEST_ASSERT_EQUAL_STRING( "\r\nid=B7 status=01 button=03 count=15 fpga_status=1\nforgix> ",
                              MOCK_BSP_ConsoleOutput() );
}
...
void test_an_empty_line_leaves_a_watch_running( void )
{
    ...
    TEST_ASSERT_EQUAL_STRING( "\r\nid=B7 status=01 button=03 count=16 fpga_status=1\nforgix> ",
                              MOCK_BSP_ConsoleOutput() );
}
