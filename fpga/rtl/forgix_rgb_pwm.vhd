...
begin
  ...
  led_r_n <= '0' when enable = '1' and phase < r_scaled(15 downto 8) else '1';
  led_g_n <= '0' when enable = '1' and phase < g_scaled(15 downto 8) else '1';
  led_b_n <= '0' when enable = '1' and phase < b_scaled(15 downto 8) else '1';
end architecture;
